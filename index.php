...
mkdir('data/txt');
mkdir('data/api');
$API_KEY= '8317311961:AAGsiiKQsqICXmOxFhB5ve9k8oD5WLd2qPY';
...
$chall = "Tttfttaf";
$useradmin = "N1_UP";
$sim =-1003172367650; #القناة الرسمية
$PAY =-1002957314176; #الارقام المكتملة
$ess =-1003106753383; #عمليات شراء الارقام
$eer =-1003138944064; #اشعارات الايميلات وتحويل الروبل
if($chat_id==7993561422){
$sudo=$chat_id;
}elseif($chat_id==7993561422){
$sudo=$chat_id;
}else{
$sudo==7993561422;
}
